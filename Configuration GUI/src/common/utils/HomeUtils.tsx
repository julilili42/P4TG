...
export const RenderTabs: React.FC<RenderTabsProps> = ({
  ...
  const categories = [
    ...
    { id: RFCTestSelection.FRAME_LOSS_RATE, name: "Frame Loss Test" },
    { id: RFCTestSelection.BACK_TO_BACK, name: "Back-to-back frames" },
    { id: RFCTestSelection.RESET, name: "Reset Test" },
  ];
