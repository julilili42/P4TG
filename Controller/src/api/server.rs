...
use crate::api::{add_port, config, configure_traffic_gen, online, ports, reset, restart, statistics, stop_traffic_gen, traffic_gen, configure_multiple_traffic_gen, run_tests, get_test_results, abort_test_profile};
...
pub async fn start_api_server(state: Arc<AppState>) {
    ...
    let api_router = Router::new()
        ...
        .route("/profiles", get(get_test_results).post(run_tests).delete(abort_test_profile))
        .layer(cors)
